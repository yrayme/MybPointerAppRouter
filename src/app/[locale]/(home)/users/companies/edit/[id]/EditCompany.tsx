...
const EditCompanies: React.FC<Props> = ({ data }) => {
    const { t } = useTranslation();
    const router = useRouter();
    const { register, errors, isLoading, isValid, handleSubmit, handleSubmitData, control, watch, entityType} = useAddCompanies(data);
    ...
    return (
        <div>
            <div className='flex gap-4 items-center'>
                ...
                <p className='font-semibold text-lg'>{t("companies:create:edit")}</p>
            </div>
            <div className='mt-10'>
                        ...
                        <div className='flex flex-col mt-4 gap-3'>
                            ...
                            <div className='flex flex-col md:grid grid-cols-1 md:grid-cols-3 gap-4'>
                                ...
                                <InputSelect
                                    ...
                                    value={watch("shipping.stateShipping")}
                                />
                                <InputSelect
                                    label={t("companies:create:bussiness:city")}
                                    ...
                                    value={watch("shipping.cityShipping")}
                                /> 
                            </div>
                            <div className='flex flex-col md:grid grid-cols-1 md:grid-cols-3 gap-4'>
                                {/* <InputSelect
